...
image_path = 'BATU/Sanskar-markesheet-1_page_1.jpg'
...
save_data_to_csv('BATU/output/marksheet-II.csv', header)
save_data_to_csv('BATU/output/marksheet-II.csv', output_data)
