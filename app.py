...
def view_csv():
    ...
    if marksheet_type == 'trialmarksheet-I':
        with open('output_data/trialmarksheet-I.csv', 'r') as csv_file:
            csv_data = list(csv.reader(csv_file))  # Read all rows of the CSV file
            csv_filename = 'trialmarksheet-I.csv'  # Example filename, replace it with the actual generated filename
    elif marksheet_type == 'marksheet-II':
